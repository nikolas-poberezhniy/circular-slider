(function () {
    ...
    let slides_2 = document.querySelectorAll('.circular-slider .wrapper .slides-holder .slides-holder__item img');
    let slides_3 = document.querySelectorAll('.circular-slider .wrapper .slides-holder .slides-holder__item img');
    ...
    Slider.prototype.slidesRepositioning = function (r) {
        ...
        for (let i = 0; i < this.slides.length; i++) {
            ...
            // rotate(' + this.stepAngle * 180 / Math.PI * i + 'deg)
        };
    ...
    Slider.prototype.rotate = function (multiplier) {
        ...
        if (this.currentSlide === this.slides.length - 1 && multiplier === -1) {
            ...
            slides_2.forEach(element => element.style.transform = 'rotate( ' + -this.currentAngle + 'deg )');
            this.addStyle();
    ...
    Slider.prototype.addStyle = function () {
        ...
        this.slides[x].style.height = this.slides[x].style.width = this.slidesSize + 270 + 'px';
    ...
    ///////////Init sliders/////////// 
    window.circularSlider1 = new Slider(document.querySelector('.circular-slider-1'), 130, 24, 600, 2500);
